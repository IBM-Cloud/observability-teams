...
team_cluster_members = ["<email_addresses_of_the_invited_users_to_your_ibm_cloud_account>"]

activity_tracker_instance_name = "<name_of_existing_activity_tracker_instance>"

logging_service_key = ""

activity_tracker_service_key = ""